...
export function AnimatedHeroContent() {
  return (
    ...
    >
      ...
      <motion.h1
        variants={fadeUp}
        className="font-heading font-light text-[#2D3B1F] tracking-widest leading-none mb-6"
      ...
      <motion.p
        variants={fadeUp}
        className="font-sans text-sm sm:text-base lg:text-lg leading-relaxed text-muted-foreground max-w-[480px] mb-10 mx-auto lg:mx-0"
      >
