...
export function Footer() {
  ...
  return (
    <footer ref={ref} className="relative bg-primary overflow-hidden py-12 lg:py-16 border-t border-white/10 snap-start lg:min-h-[100svh] flex flex-col justify-center">
      {/* Noise texture */}
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-8 mb-8 md:mb-10">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <Link href="/" onClick={(e) => { e.preventDefault(); scrollToSection(""); }} className="group mb-4 md:mb-8" aria-label={`${TEXTS.SITE.name} — Voltar ao topo`}>
              <BrandLogo 
                ...
                taglineClassName="text-[10px] sm:text-[11px] tracking-[0.45em] sm:tracking-[0.5em] text-center md:text-left mt-2"
              />
            </Link>
            <p className="font-heading italic text-2xl sm:text-[22px] text-white/90 max-w-sm leading-snug mb-0 md:mb-8">
          ...
          <div className="flex flex-col items-center md:items-end text-center md:text-right">
            ...
            <div className="flex items-center justify-center md:justify-end gap-6">
              ...
              <a href={TEXTS.SITE.facebook} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors duration-200 focus-visible:outline-white" aria-label="Facebook">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center md:justify-end gap-1.5 sm:gap-4 mt-4 md:mt-0">
             <p className="hidden md:block font-sans text-[11px] text-white/40 tracking-wider">
               {TEXTS.FOOTER.madeIn}
             </p>
